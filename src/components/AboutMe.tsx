    ...
    <div className="mb-8">
      ...
      <div className="text-gray-300 leading-relaxed space-y-4">
        <p className="font-normal">
          Hey there! I'm Prasant, a Computer Science student at who's likes to build stuff that solves small but annoying issues. Currently working as a Web/App Intern At Optimal Answers, LLC.
        </p>
        <p className="font-normal">
